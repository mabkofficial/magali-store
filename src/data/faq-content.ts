    ...
    items: [
      {
        ...
        a: "Standard products typically arrive within 5 to 7 business days in the contiguous United States. Frozen items may ship on a separate timeline when available for online checkout.",
      },
      {
      ...
      },
      {
        ...
        a: "You will receive an order confirmation by email after checkout. Tracking details are sent when your order ships.",
      },
    ],
  },
  {
